...
def run_repeated_fasttext(
    ...
    return run_repeated(lambda seed: run_fasttext_test(name=f"{name}_{seed}", seed=seed, verbose=verbose, model_file=model_file))
...
def run_repeated_transformer(
    ...
    return run_repeated(lambda seed: run_transformer_test(name=f"{name}_{seed}", seed=seed, verbose=verbose), seed_start=seed_start, seed_end=seed_end)
